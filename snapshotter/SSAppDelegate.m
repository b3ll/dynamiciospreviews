...
- (void)applicationWillResignActive:(UIApplication *)application
{
    ...
    [(SSViewController *)self.window.rootViewController setInstagramUIHidden:YES animated:YES];
}
...
- (void)applicationDidBecomeActive:(UIApplication *)application
{
    ...
    [(SSViewController *)self.window.rootViewController setInstagramUIHidden:NO animated:YES];
